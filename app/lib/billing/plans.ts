...
export const PAID_PLANS = [
  {
    ...
    features: [
      ...
      "Enough for ~20 Marketing images, 50 Design images, or 25 seconds of video",
      "4K resolution",
    ],
  },
  {
    ...
    priceAmount: 240,
    priceLabel: "$240/year",
    priceMetaLabel: "Billed yearly, credits granted monthly",
    creditsPerMonth: 20,
    creditPriceLabel: "$1.00/credit",
    ctaLabel: "Choose Starter Annual",
    features: [
      "20 credits added each month",
      "Enough for ~20 Marketing images, 50 Design images, or 25 seconds of video per month",
      "4K resolution",
    ],
  },
  {
    ...
    features: [
      ...
      "Enough for ~110 Marketing images, 275 Design images, or 150 seconds of video",
      "4K resolution",
    ],
  },
  {
    ...
    features: [
      ...
      "Enough for ~110 Marketing images, 275 Design images, or 150 seconds of video per month",
      "4K resolution",
    ],
  },
  {
    ...
    features: [
      ...
      "Enough for ~250 Marketing images, 625 Design images, or 330 seconds of video",
      "4K resolution",
    ],
  },
  {
    ...
    features: [
      ...
      "Enough for ~250 Marketing images, 625 Design images, or 330 seconds of video per month",
      "4K resolution",
    ],
  },
] as const;
