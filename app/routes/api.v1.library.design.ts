...
/**
 * GET /api/v1/library/design
 * Proxies the IMAI design library endpoint with cursor-based pagination
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const imaiUrl = new URL("https://www.imai.studio/api/v1/library/design");
